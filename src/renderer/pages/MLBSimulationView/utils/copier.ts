...
import { convertTableToTSV } from '@/utils/copyUtils';
import { formatFirstInningData, firstInningColumns } from '@/components/FirstInningTable';
import { formatSidesData, sidesColumns } from '@/components/SidesTable';
import { formatTotalsData, totalsColumns } from '@/components/TotalsTable';
import { formatSeriesData, seriesColumns } from '@/components/SeriesTable';
