...
import { runSeriesSimulation, runSimulation } from "@/pages/MLBMatchupView/functions/simulation";
...
export const runSeriesSimulationThunk = createAsyncThunk(
  ...
  async ({
    ...
    const results = await runSeriesSimulation(gameInputs, numGames);
    return results;
  }
);
